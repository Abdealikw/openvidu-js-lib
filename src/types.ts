export type WebrtcCtor = new (configuration?: RTCConfiguration) => RTCPeerConnection | any;
export type WebsocketCtor = new (url: string, protocols?: string | string[]) => WebSocket | any;
